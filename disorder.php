...
$stmt = $conn->prepare("update users set balance = balance + ".$price_after_halve_of_brokerage." where UserID = ".$buyer);
...
if($count1 > 0){
     // add notifiction 
     $message = "تم  إلغاء خدمة  " . $service['Name'] . " من قبل العميل ". $client['Username'] ;
